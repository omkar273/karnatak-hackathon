...
const ManpowerStatic = () => {
  const rapidActionsColumns = [
    ...
    },
    {
      ...
      render: (forces: string) => (
        <span className="font-semibold text-base">{forces}</span>
      ),
    },
    {
      title: "Name",
  ...
  const chartSettings = {
    ...
    sx: {
      [`.${axisClasses.left} .${axisClasses.label}`]: {
        transform: "translate(-20px, 10px0)",
      },
    },
  };
  ...
  const pieChartData = departmentDetails.map((d) => ({
    id: d.dept_name,
    value: d.no_people,
    label: d.dept_name,
  }));
    ...
    <div className="max-h-screen overflow-y-scroll overflow-hidden bg-gray-100">
      ...
      <div className="p-4">
            ...
            items={[
              {
                ...
                children: (
                  <iframe
                    ...
                    src="https://maps.google.com/maps?q=14.51475,75.80687&amp;hl=es;z=14&amp;output=embed"
                    title="map"
                  ></iframe>
                ),
              },
        ...
        <div className="bg-white p-4 my-4 card">
          <p className="my-4 font-bold text-xl">Skills and training details</p>
        ...
        <div className="bg-white p-4 my-4 card">
          <p className="my-4 font-bold text-xl">Rapid Action Forces</p>
        ...
        <div className="bg-white p-4 my-4 card">
          <p className="my-4 font-bold text-xl">Forensic Unit</p>
        ...
        <div className="bg-white p-4 my-4 card">
          <p className="my-4 font-bold text-xl">Moving Unit</p>
