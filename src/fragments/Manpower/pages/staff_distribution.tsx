...
const StaffDistribution = () => {
  const [distributionType, setDistributionType] =
    useState<StaffDistributionEnum>(StaffDistributionEnum.Ranks);

  return (
    <div className="max-h-screen overflow-y-scroll overflow-hidden bg-gray-100">
      <div className="bg-white p-3 border-b-2 border  flex justify-between items-center  sticky  top-0 z-[100]">
        ...
        >
          ...
          <Radio.Button value={StaffDistributionEnum.Department}>
            Dept
          </Radio.Button>
          <Radio.Button value={StaffDistributionEnum.Skill}>
            Skills
          </Radio.Button>
        </Radio.Group>
      </div>
      <div className="p-4">
        ...
        <div
          className={
            "relative h-[50vh] overflow-hidden p-4 rounded-md bg-white my-4"
          }
        >
