...
const LawOrderPage = () => {
    const trafficMnagamentColumns = [
        ...
        },
        {
            ...
            "dataIndex": "location",
            "key": "location",
            render: (location: string) => (<span className="font-semibold text-base">{location}</span>)
        },
        {
        ...
        <div className="max-h-screen overflow-y-scroll overflow-hidden bg-gray-100">
            ...
            <div className="p-4">
                ...
                <div className="bg-white p-4 my-4 card">
                    ...
                    <Table
                        dataSource={law_and_order_data.traffic_reports}
                        columns={trafficMnagamentColumns}
                        pagination={{
                            total: law_and_order_data.traffic_reports.length,
                            showSizeChanger: true,
                            showQuickJumper: true,
                            showTotal: (total, range) => `Showing ${range[0]}-${range[1]} of ${total} items`,
