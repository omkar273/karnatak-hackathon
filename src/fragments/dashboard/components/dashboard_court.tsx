...
const CourtOrders: React.FC<Props> = ({lat, lng, station_id, station_name}) => {
					...
					<div className="flex gap-4">
						<div className="w-1/2 py-2 max-h-[20px]">
							<div className="w-fullpy-2 max-h-[200px] overflow-hidden">
								<StaticMap station_id={station_id} lng={lng} lat={lat} station_name={station_name}/>
							</div>
						</div>
						<div className="w-1/2">
							<Table
